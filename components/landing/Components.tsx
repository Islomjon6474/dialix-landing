...
const Components = observer(() => {
  return (
    <div className="observe-section overflow-hidden w-screen min-h-screen rounded-2xl flex flex-col items-center justify-center">
      <div className="p-8 md:p-16 flex flex-col items-center sm:items-start justify-center w-full leading-6 gap-10">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 text-center leading-[22px] sm:text-start">
          <div className="container w-full md:w-1/2 h-full p-6 rounded-2xl flex flex-col items-start justify-center text-start">
            <Image
